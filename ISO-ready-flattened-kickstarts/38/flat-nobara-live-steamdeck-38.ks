...
# Force steam deck edition installs to boot into gamescope-session
echo "    - \"sed -i 's/Session=plasma/Session=gamescope-session/g' /etc/sddm.conf\"" >> /usr/share/calamares/modules/shellprocess.conf
