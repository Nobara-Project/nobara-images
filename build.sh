...
livemedia-creator --ks ISO-ready-flattened-kickstarts/nv-flat-nobara-live-steam-htpc-42.ks --no-virt --resultdir ./release --project Nobara --make-iso --volid Nobara-42 --iso-only --iso-name Nobara-42-Steam-HTPC-NV-$(date +%F).iso --releasever 42 --macboot --extra-boot-args "modules_load=nvidia"
mv ./release/*.iso ./complete
rm -Rf ./release
